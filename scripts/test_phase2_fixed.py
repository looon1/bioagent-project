...
class Phase2UnifiedTester:
    ...
    async def setup_test_environment(self):
        ...
        try:
            ...
            self.test_results['agent_init'] = {
                ...
                'tools_count': len(self.agent.tool_registry.tools),
                'domains': list(self.agent.tool_registry.domains)
            }
            print(f"   ✓ Agent initialized with {len(self.agent.tool_registry.tools)} tools")
    ...
    async def test_tool_adapter_system(self):
        ...
        # Test 1: ToolAdapter with registry
        print("\n1. Testing ToolAdapter with registry...")
        try:
            ...
            self.test_results['tool_adapter_base'] = {
                ...
                'has_registry': adapter.registry is not None
            }
            print("   ✓ ToolAdapter created with registry")
        ...
        # Test 3: Tool registry with agent
        print("\n3. Testing Tool registry with agent integration...")
        try:
            ...
            core_tools = self.agent.tool_registry.list_tools_by_domain("database")
        ...
        try:
            # Test with mock environment to avoid API calls
            ...
            self.test_results['tool_execution_consistency'] = {
                ...
                'agent_status': self.agent.state.status
            }
    ...
    async def test_multi_agent_teams(self):
        ...
        try:
            ...
            # Test team interface
            sub_agents = [agent.session_id for agent in team.subagents]
        ...
        try:
            ...
            team = AgentAsToolTeam(
                leader=leader,
                subagents=[assistant1, assistant2],
                agent_descriptions={
                    assistant1.session_id: "Data analysis specialist",
                    assistant2.session_id: "Literature search specialist"
                }
            )
        ...
        try:
            ...
            # Test team interface
            initial_agent = team.active_agent.session_id
            ...
            print(f"   ✓ Swarm team created with active agent: {initial_agent}")
    ...
    async def test_unified_api_interface(self):
        ...
        try:
            ...
            tools_info = self.agent.tool_registry.list_tools()
        ...
        try:
            ...
            tools_to_test = self.agent.tool_registry.list_tools()[:3]
            schema_consistent = 0
    ...
    async def test_error_handling_consistency(self):
        ...
        try:
            # Mock tool execution error handling
            error_caught = True
